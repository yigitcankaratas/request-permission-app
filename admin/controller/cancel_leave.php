...
if ($row6['leave_start'] < date("Y-m-d")){
    ...
    $query5 = $db->prepare("UPDATE leaves SET statue = 3, statue_id = 0 WHERE id = '$id' ");
    $query5->execute();
...
//$mail->addAttachment('PHPMailer-master.zip', 'phpmailkullanimi.zip');
    ...
    $mail->Body    =  "<p align='center'><img src=\"cid:logo\" ></p>" .
        ...
        "<p>Aşağıda bilgileri verilen izin talebi, İnsan Kaynakları Yöneticisi tarafından iptal edilmiştir.</p><br/>".

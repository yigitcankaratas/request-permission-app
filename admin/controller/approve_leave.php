...
$id = get('id');
$query5 = $db->prepare("UPDATE leaves SET statue = 2, statue_id = 0 WHERE id = '$id' ");
$query5->execute();
...
$mail->Body    =  "<p align='center'><img src=\"cid:logo\" ></p>" .
    ...
    "<p>Aşağıda bilgileri verilen izin talebi, İnsan Kaynakları Yöneticisi tarafından onaylanmıştır. Talepte sorun olduğunun düşünülmesi
    halinde, talep yöneticiler tarafından iptal edilebilir durumdadır.</p><br/>".
...
require admin_controller('leave-requests');

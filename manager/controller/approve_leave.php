...
$mail->Body    =  "<p align='center'><img src=\"cid:logo\" ></p>" .
    ...
    "<p>Aşağıda bilgileri verilen izin talebi, " . $row8['name'] . " " . $row8['surname'] . " tarafından onaylanmıştır. Talepte sorun olduğunun düşünülmesi
...
require manager_controller('leave-requests');
